...
?>
	...
	<div class="margin-top">
		<div class="span12">
					...
					<div class="alert alert-info"><Strong>РАСКАЗИ </strong>&nbsp;
            ...
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="divider-vertical"></li>
					<li class="">
					<a rel="tooltip"  data-placement="bottom"  id="login" href="#">&nbsp;Раскази</a>
					</li>
	...
	-->
	<?php
		$user_query=mysqli_query($mysqli,"select * from ebooks where status != 'Archive' and category_name = 'Raskazi'")or die(mysql_error($mysql));									
		while($row=mysqli_fetch_array($user_query)){
		$id=$row['book_id'];  
