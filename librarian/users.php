		...
		<div class="margin-top">
			...
			<div class="span2">			     
										<ul class="nav nav-tabs nav-stacked">
											<li>
											<a href="#add_user" data-toggle="modal" ><i class="icon-plus icon-large"></i>&nbsp;<strong>Додади Админ</strong></a>
											</li>
										</ul>
			...
			<div class="span10">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" >
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;АДМИНИ</strong>
                                </div>
                                <thead>
                                    <tr>
                                        ...
                                        <th>Име</th>                                 
                                        <th>Презиме</th>                                 
                                        <th>Избриши/Измени</th>
                                    </tr>
                                </thead>
                                <tbody>
								 
                                  <?php $user_query=mysqli_query($mysqli,"select * from users")or die(mysql_error());
