		...
		<div class="margin-top">
			...
			<div class="span12">	
			   <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Членови</strong>
                                </div>
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered">
                             
								<p><a href="add_member.php" class="btn btn-success"><i class="icon-plus"></i>&nbsp;Додади корисник</a></p>
                                ...
                                <tbody>
                                  ...
                                  <?php  $user_query=mysqli_query($mysqli,"select * from member")or die(mysql_error());
