...
<div class="span12">
					<div class="alert alert-info"><Strong>ДЕТСКА ЛИТЕРАТУРА </strong>&nbsp;
		...
		<!-- MENU -->
            ...
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="divider-vertical"></li>
					<li class="">
					<a rel="tooltip"  data-placement="bottom" title="Click Here to About" id="login" href="#">&nbsp;Детстка литература</a> 
					</li>
					<li class="divider-vertical"></li>
					<li class="">
	...
	<!--
	<div class="gallery3">
		<a target="_blank" href="knigi/kniga3">
	...
	<div class="gallery3">
		<a target="_blank" href="knigi/kniga8">
	...
	<div class="gallery3">
		<a target="_blank" href="knigi/kniga17">
	...
	-->
	<?php
		$user_query=mysqli_query($mysqli,"select * from ebooks where status != 'Archive' and category_name = 'DetskaLiteratura'")or die(mysql_error($mysql));									
		while($row=mysqli_fetch_array($user_query)){
		$id=$row['book_id'];  
